...
ckpt_dir=`grep '^restore_dir' conf/kaiwudrl/configure.toml | cut -d '=' -f2 | tr -d ' '`
app=`grep '^app' conf/kaiwudrl/configure.toml | cut -d '=' -f2 | tr -d ' '`
algo=`grep '^algo' conf/kaiwudrl/learner.toml | cut -d '=' -f2 | tr -d ' '`
