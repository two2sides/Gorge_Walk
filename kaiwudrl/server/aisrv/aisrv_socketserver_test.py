...
# @file aisrv_socketserver_test.py
# @brief
# @author kaiwu
# @date 2023-11-28
...
class AisrvSocketServerTest(unittest.TestCase):
    ...
    def on_update(self):
        ...
        update_req = KaiwuMsgHelper.encode_update_req(builder, "client-1", 2, {0: [b"Hello 1"], 1: [b"Hello 2"]})
    ...
    def on_update_fun(self):
        ...
        req = KaiwuMsgHelper.encode_update_req(builder, "client_id", 0, {1: [b"Hello 1"], 2: [b"Hello 2"]})
