...
# @file actor_proxy_local_test.py
# @brief
# @author kaiwu
# @date 2023-11-28
...
# 单侧时加上的, 因为在调用ActorProxyLocal需要对接口里的函数进行处理, 正式上线的不需要
...
class ActorProxyLocalTest(unittest.TestCase):
    def test_put_and_get(self):
        ...
        actor_proxy.actor_proxy.configure_mock(**{"recv.return_value": [((1, 2), {"x": np.ones((4,))})]})
