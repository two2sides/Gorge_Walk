...
class CosUtilTest(unittest.TestCase):
    ...
    def test_cos_push_pull(self):
        ...
        file_name = "/data/projects/kaiwu-fwk/kaiwudrl/common/utils/cos_utils_test.py"
        file_name_new = "/data/projects/kaiwu-fwk/kaiwudrl/common/utils/cos_utils_test_new.py"
