...
class ZmqReader:
    ...
    def readable(self):
        return self._reader.poll(1000, flags=zmq.POLLIN) == zmq.POLLIN
...
class ZmqWriter:
    ...
    def writable(self):
        return self._writer.poll(1000, flags=zmq.POLLOUT) == zmq.POLLOUT
...
class ZmqServer:
    ...
    def __init__(self, ip, port, duplex=False):
        self._context = zmq.Context()
    ...
    def readable(self):
        return self._socket.poll(1000, flags=zmq.POLLIN) == zmq.POLLIN
    ...
    def writable(self):
        return self._socket.poll(1000, flags=zmq.POLLOUT) == zmq.POLLOUT
...
class ZmqClient:
    ...
    def __init__(self, client_id, ip, port, duplex=False):
        self._context = zmq.Context()
