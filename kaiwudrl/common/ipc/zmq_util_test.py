...
from kaiwudrl.common.ipc.zmq_util import ZmqReader
from kaiwudrl.common.ipc.zmq_util import ZmqServer
from kaiwudrl.common.ipc.zmq_util import ZmqWriter
    ...
    def server(self):
        ...
        while True:
            try:
                ...
                if data:
                    print(f"server recv data success, data is {data}")
                    zmq_server.send(client_id, data)
                    print(f"server send data success, data is {data}")
            except Exception as e:
                print(f"send or recv error, message is {str(e)}")
                pass
    ...
    def client(self):
        ...
        while True:
            try:
                ...
                print(f"client send success, data is {data}")

                data = zmq_client.recv(block=False, binary=True)
                print(f"client recv success, data is {data}")
...
if __name__ == "__main__":
    ...
    configure_file = "conf/kaiwudrl/actor.toml"
