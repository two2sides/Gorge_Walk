...
from kaiwudrl.common.utils.common_func import (
    get_first_line_and_last_line_from_file,
    make_tar_file,
    tar_file_extract,
)
...
class ModelFileSyncTest(unittest.TestCase):
    ...
    def test_push_to_modelpool(self):
        ...
        with open(output_file_name, "rb") as fin:
            ...
            model_pool_apis.push_model(
                model=model,
                hyperparam=None,
                key="model.ckpt_sgame_ppo",
                md5sum=local_md5,
    ...
    def test_pull_from_modelpool(self):
        ...
        for model_name in model_name_list:
            ...
            tar_file_extract(
                f"/data/ckpt/sgame_ppo/plugins/{model_file_name}",
                "/data/ckpt/sgame_ppo/plugins/",
            )
