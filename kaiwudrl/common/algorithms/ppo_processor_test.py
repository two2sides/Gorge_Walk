...
from kaiwudrl.common.algorithms.distribution import GaussianDist
from kaiwudrl.common.algorithms.ppo_processor import PPOProcessor
from kaiwudrl.common.utils.common_func import Context
from kaiwudrl.interface.agent_context import AgentContext
from kaiwudrl.interface.action import ActionSpec
...
class PPOProcessorTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._agent_ctx.state = {"train": MockState(value=[1.0, 2.0])}
        ...
        self._agent_ctx.policy_conf = {"train": MockPolicyConf()}
        ...
        self._ppo_processor = PPOProcessor(simu_ctx=self._simu_ctx, agent_ctx=self._agent_ctx, policy_id="train")
