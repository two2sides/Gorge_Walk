...
def cal_elo(
    winrate_file,
    fix_model_file="fixModel/fix_score_model_label.txt",
    iteration_num=10000,
):
    res = []
    fix_model_dict = {}
    ...
    for i in range(iteration_num):
        ...
        for line in res:
            ...
            camp1_update = elo_update(
                expected(result_dict[camp1_version], result_dict[camp2_version]),
                camp1_score,
                k=32,
            )
