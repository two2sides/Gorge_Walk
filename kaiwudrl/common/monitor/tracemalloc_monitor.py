...
import linecache
import json
from kaiwudrl.common.monitor.monitor_base import MonitorDecoratorBase
...
class TraceMallocMonitorDecorator(MonitorDecoratorBase):
    ...
    def end_monitor(self):
        ...
        display += (
            f"#### Tracemalloc Memory Profile. Compare memory snapshot from "
